...
<div id="app">
    <?php include('pages/loginPage.html'); ?>
    <?php include('pages/loadingPage.html'); ?>
    <div class="wrapper hidden" id="dashboardPage">
        <?php include('pages/dashboard/main-header.html'); ?>
        <?php include('pages/dashboard/main-sidebar.html'); ?>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2017 <a href="http://guide4all.es/">Guide4all</a>.</strong> All rights
            reserved.
        </footer>
    </div>
</div>
...
<!--APP JS-->
<script src="js/modulePagination.js"></script>
